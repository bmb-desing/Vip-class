    ...
    <header class="header">
        <div class="header__wrapper">
            <div class="header__left">
                <div class="burger" @click="menuShow" v-bind:class="{active: activeMenu}">
                    <span class="burger__item burger__item_first"></span>
                    <span class="burger__item burger__item_center"></span>
                    <span class="burger__item burger__item_last"></span>
                </div>
                <div class="logo">
                    <nuxt-link :to="{name: 'index'}" class="logo__link">
            ...
            <div class="header__right">
                <nuxt-link :to="{name: 'index'}" class="info">
                    <svg version="1.1" id="info__svg" class="info__svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	<g>
		<path d="M153.6,191.147h-47.787c-1.884,0-3.413,1.529-3.413,3.413c0,1.884,1.529,3.413,3.413,3.413H153.6
			c1.884,0,3.413-1.529,3.413-3.413C157.013,192.676,155.484,191.147,153.6,191.147z"/>
                    ...
                    <span class="info__text">Спецпредложение</span>
                </nuxt-link>
